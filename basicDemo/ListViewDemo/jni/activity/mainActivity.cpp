...
static S_ButtonCallback sButtonCallbackTab[] = {
    ID_MAIN_WinHideButton, onButtonClick_WinHideButton,
    ID_MAIN_Button3, onButtonClick_Button3,
    ID_MAIN_Button2, onButtonClick_Button2,
    ID_MAIN_ConcelButton, onButtonClick_ConcelButton,
    ID_MAIN_OKButton, onButtonClick_OKButton,
    ID_MAIN_Button1, onButtonClick_Button1,
    ID_MAIN_AddButton, onButtonClick_AddButton,
    ID_MAIN_CityButton, onButtonClick_CityButton,
};
/***************/
...
static S_ListViewFunctionsCallback SListViewFunctionsCallbackTab[] = {
    ID_MAIN_CityListView, getListItemCount_CityListView, obtainListItemData_CityListView, onListItemClick_CityListView,
...
void mainActivity::onCreate() {
    ...
    mWinHideButtonPtr = (ZKButton*)findControlByID(ID_MAIN_WinHideButton);
    mTextView_TipPtr = (ZKTextView*)findControlByID(ID_MAIN_TextView_Tip);
    mListWindowPtr = (ZKWindow*)findControlByID(ID_MAIN_ListWindow);
    mCityWindowPtr = (ZKWindow*)findControlByID(ID_MAIN_CityWindow);
    ...
    mConcelButtonPtr = (ZKButton*)findControlByID(ID_MAIN_ConcelButton);
    mOKButtonPtr = (ZKButton*)findControlByID(ID_MAIN_OKButton);
    ...
    mAddButtonPtr = (ZKButton*)findControlByID(ID_MAIN_AddButton);
    mCityListViewPtr = (ZKListView*)findControlByID(ID_MAIN_CityListView);if(mCityListViewPtr!= NULL){mCityListViewPtr->setListAdapter(this);mCityListViewPtr->setItemClickListener(this);}
    mCityButtonPtr = (ZKButton*)findControlByID(ID_MAIN_CityButton);
