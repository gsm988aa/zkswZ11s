...
//  mOpenSoftApButtonPtr->setVisible(false);
//  mOpenSoftApButtonPtr->setText("该平台不支持");
//#endif
}
...
static bool onButtonClick_OpenEtherNetButton(ZKButton *pButton) {
	EASYUICONTEXT->openActivity("ethernetsettingActivity");
    return false;
}

static bool onButtonClick_OpenLte4GButton(ZKButton *pButton) {
