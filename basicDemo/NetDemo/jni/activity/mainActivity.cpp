...
static ZKButton* mOpenLte4GButtonPtr;
static ZKButton* mOpenEtherNetButtonPtr;
...
static S_ButtonCallback sButtonCallbackTab[] = {
    ID_MAIN_OpenLte4GButton, onButtonClick_OpenLte4GButton,
    ID_MAIN_OpenEtherNetButton, onButtonClick_OpenEtherNetButton,
...
void mainActivity::onCreate() {
	Activity::onCreate();
    mOpenLte4GButtonPtr = (ZKButton*)findControlByID(ID_MAIN_OpenLte4GButton);
    mOpenEtherNetButtonPtr = (ZKButton*)findControlByID(ID_MAIN_OpenEtherNetButton);
