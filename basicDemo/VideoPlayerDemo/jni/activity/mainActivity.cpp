...
static S_ButtonCallback sButtonCallbackTab[] = {
    ...
    ID_MAIN_VoiceButton, onButtonClick_VoiceButton,
    ID_MAIN_ButtonZoom, onButtonClick_ButtonZoom,
...
static S_VideoViewCallback SVideoViewCallbackTab[] = {
    ID_MAIN_VideoviewTT, false, 5, onVideoViewPlayerMessageListener_VideoviewTT,
};
...
void mainActivity::onCreate() {
    ...
    mSoundWindowPtr = (ZKWindow*)findControlByID(ID_MAIN_SoundWindow);
    mDurationTextViewPtr = (ZKTextView*)findControlByID(ID_MAIN_DurationTextView);
    mCurPosTextViewPtr = (ZKTextView*)findControlByID(ID_MAIN_CurPosTextView);
    msys_backPtr = (ZKButton*)findControlByID(ID_MAIN_sys_back);
    mVoiceButtonPtr = (ZKButton*)findControlByID(ID_MAIN_VoiceButton);
    mButtonZoomPtr = (ZKButton*)findControlByID(ID_MAIN_ButtonZoom);
    ...
    mVideoviewTTPtr = (ZKVideoView*)findControlByID(ID_MAIN_VideoviewTT);if(mVideoviewTTPtr!= NULL){mVideoviewTTPtr->setVideoPlayerMessageListener(this);}
	mActivityPtr = this;
	onUI_init();
