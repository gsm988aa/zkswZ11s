...
static const int MODE_RANDOM = 0;
...
static void onProtocolDataUpdate(const SProtocolData &data) {
  ...
  //向本机串口发送 FF 55 00 01 01 09   可控制指针旋转到9°
  //向本机串口发送 FF 55 00 01 01 B4   可控制指针旋转到180°

  if (mode != MODE_SERIAL) {
    return;
  }
  mPointer1Ptr->setTargetAngle(data.value);
